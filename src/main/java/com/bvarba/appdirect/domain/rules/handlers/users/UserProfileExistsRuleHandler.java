...
public class UserProfileExistsRuleHandler extends UserProfileRuleHandler {
	public UserProfileExistsRuleHandler(UserProfileRepository userProfileRepo) {
	...
	public void validate(Event incomingBusinessData) {
		...
		if (existingUser == null) {
			ErrorNotificationEventResponse errorResponse = new ErrorNotificationEventResponse(
					"User with the provided uuid account with " + userUuid + " does not exist...",
